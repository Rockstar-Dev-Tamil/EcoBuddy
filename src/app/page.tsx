  ...
  () => import("@/features/planet-3d/planet-viewer").then((mod) => mod.PlanetViewer),
  {
    ...
    loading: () => (
      <div className="w-full h-full flex flex-col items-center justify-center min-h-[180px] bg-zinc-950/20 border border-zinc-800/40 rounded-2xl">
        ...
        <span className="text-[9px] font-syne font-bold text-zinc-500 uppercase tracking-widest">3D Planet Loading...</span>
      </div>
    ),
  }
);
        ...
        <>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              >
                <Image src="/logo.png" alt="EcoBuddy logo" width={40} height={40} className="object-contain" />
              </motion.div>
              <div className="flex flex-col">
                ...
                <span className="text-[8px] text-zinc-500 font-mono tracking-widest uppercase">Ecosystem Companion</span>
              </div>
            </div>
          ...
          <div className="flex-1 flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 z-10 py-8 lg:py-0">
            <div className="max-w-[1400px] w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
              ...
              >
                ...
                <p className="text-zinc-400 text-sm sm:text-base max-w-xl leading-relaxed">
                  EcoBuddy AI translates active transportation, organic diet, smart electricity, and recycling logs into a beautiful, living 3D ecosystem. Track your carbon decisions in real-time.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 max-w-2xl py-4 border-y border-white/5">
                  <div className="flex flex-col gap-1">
                    ...
                    <span className="text-[10px] text-zinc-500 font-bold uppercase tracking-wider leading-snug">CO₂ decisions simulated</span>
                  </div>
                  <div className="flex flex-col gap-1">
                    <span className="font-syne font-extrabold text-2xl sm:text-3xl text-[#1DE9B6]">
                      <AnimatedCounter value={25000} />
                    </span>
                    <span className="text-[10px] text-zinc-500 font-bold uppercase tracking-wider leading-snug">Eco actions tracked</span>
                  </div>
                  <div className="flex flex-col gap-1">
                    <span className="font-syne font-extrabold text-2xl sm:text-3xl text-white">
                      <AnimatedCounter value={100} />
                    </span>
                    <span className="text-[10px] text-zinc-500 font-bold uppercase tracking-wider leading-snug">Daily challenges</span>
                  </div>
                  <div className="flex flex-col gap-1">
                    <span className="font-syne font-extrabold text-2xl sm:text-3xl text-accent font-mono">
                      ∞
                    </span>
                    <span className="text-[10px] text-zinc-500 font-bold uppercase tracking-wider leading-snug">Future possibilities</span>
                  </div>
                </div>
              </motion.div>
            ...
            >
              <div className="flex flex-col gap-2 mb-10 text-center sm:text-left select-none">
                <span className="text-[10px] text-accent uppercase font-extrabold tracking-[0.2em]">Comprehensive Platform Features</span>
                <h3 className="font-syne font-extrabold text-2xl sm:text-3xl text-white">Gamified Platform Bento</h3>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-stretch">
                ...
                <div 
                  className="md:col-span-6 glass-panel p-6 border border-white/5 flex flex-col justify-between overflow-hidden relative group hover:border-[#00E676]/30 hover:shadow-[0_8px_32px_rgba(0,230,118,0.08)] transition-all duration-300"
                >
                  <div className="z-10 select-none">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="font-syne font-extrabold text-xs text-white uppercase tracking-wider">Personalized Planet</span>
                    </div>
                    <p className="text-[11px] text-zinc-400 leading-relaxed max-w-sm mt-1">
                      Observe a living low-poly planetary model. The vegetation density, rivers, clouds, and animal ecosystem react dynamically to your carbon logs.
                    </p>
                  </div>
                ...
                >
                  <div className="z-10 select-none">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="font-syne font-extrabold text-xs text-cyan-400 uppercase tracking-wider">EcoSnap Vision</span>
                    </div>
                    <p className="text-[11px] text-zinc-400 leading-relaxed max-w-sm mt-1">
                      Upload receipt slips, grocery wrappers, or energy statements. Gemini Vision parses and calculates immediate carbon points.
                    </p>
                  </div>
                ...
                <div 
                  className="md:col-span-7 glass-panel p-6 border border-white/5 flex flex-col justify-between overflow-hidden relative group hover:border-[#00E676]/30 hover:shadow-[0_8px_32px_rgba(0,230,118,0.08)] transition-all duration-300"
                >
                  <div className="z-10 select-none">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="font-syne font-extrabold text-xs text-indigo-400 uppercase tracking-wider">AI twin (Sprig)</span>
                    </div>
                    <p className="text-[11px] text-zinc-400 leading-relaxed max-w-md mt-1">
                      Converse with Sprig, your virtual tree-spirit companion. Sprig answers plant-based recipe requests, commutes audit parameters, and tracks environmental milestones.
                    </p>
                  </div>
                ...
                <div 
                  className="md:col-span-5 glass-panel p-6 border border-white/5 flex flex-col justify-between overflow-hidden relative group hover:border-[#00E676]/30 hover:shadow-[0_8px_32px_rgba(0,230,118,0.08)] transition-all duration-300"
                >
                  <div className="z-10 select-none">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="font-syne font-extrabold text-xs text-amber-400 uppercase tracking-wider">Earth 2050</span>
                    </div>
                    <p className="text-[11px] text-zinc-400 leading-relaxed max-w-sm mt-1">
                      Simulate planetary regional climate models (CO₂ density, AQI, sea levels) depending on user habit trajectories.
                    </p>
                  </div>
